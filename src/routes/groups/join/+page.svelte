<script lang="ts">
    ...
    function getEnumValueFromKey(key: string) {
        switch (key) {
            ...
            <Card.Content class="space-y-8 py-4"> 
                <Form.Field {form} name="region">
                    <Form.Control let:attrs>
                        ...
                        <Label class="font-normal text-xs">Escreva todas as regiões onde estaria diposto a fazer o patrocínio (presencial)</Label>
                    </Form.Control>
                    <Form.FieldErrors />
                </Form.Field>
